...
class AddWinnerFlags extends Migration
{
    ...
    public function up()
    {
        ...
        ->each(function($flag) {
            ...
            $flag->winner_description = 'Felipe dos Santos Stum - 18 anos - 3° ano do ensino médio - CIEP 179 Prof. Cláudio Gama';
        ...
        Flag::where('filename', 'metro3.jpg')
            ...
            ->each(function($flag) {
                ...
                $flag->winner_description = 'Yasmin Silvares de Azevedo - 17 anos - 2° ano do Ensino médio - CIEP 323 Maria Werneck de Castro';
        ...
        Flag::where('filename', 'metro4.jpg')
            ...
            ->each(function($flag) {
                ...
                $flag->winner_description = 'João Pedro Grangeiro Monteiro - 17 anos - 3° ano do ensino médio - CIEP 165 Brigadeiro Sérgio Carvalho';
