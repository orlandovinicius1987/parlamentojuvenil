            ...
            <div class="col-sm-12">
                ...
                <nav id="menu" class="menu collapse navbar-collapse">
                    <ul id="headernavigation" class="menu-list nav navbar-nav">
                        ...
                        <li class="social-buttons"><a target="_blank" class="" href="https://www.facebook.com/parlamentojuvenilrio/"><i class="fa fa-facebook"></i></a></li>
                        <li class="social-buttons"><a target="_blank" class="" href="#about"><i class="fa fa-twitter"></i></a></li>
                        <li class="social-buttons"><a target="_blank" class="" href="#contact"><i class="fa fa-instagram"></i></a></li>
                        <li class="social-buttons ultimo"><a target="_blank" class="" href="https://www.youtube.com/user/parlamentojuvenilrj"><i class="fa fa-youtube"></i></a></li>
