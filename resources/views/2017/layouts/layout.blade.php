            ...
            <div class="col-sm-12">
                ...
                <nav id="menu" class="menu collapse navbar-collapse">
                    <ul id="headernavigation" class="menu-list nav navbar-nav">
                        ...
                        <li class="social-buttons"><a class="" href="#portfolio"><i class="fa fa-facebook"></i></a></li>
                        <li class="social-buttons"><a class="" href="#about"><i class="fa fa-twitter"></i></a></li>
                        <li class="social-buttons"><a class="" href="#contact"><i class="fa fa-instagram"></i></a></li>
                        <li class="social-buttons ultimo"><a class="" href="#contact"><i class="fa fa-youtube"></i></a></li>
