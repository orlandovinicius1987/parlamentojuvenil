<div id="sobre" class="conteudo">
    <div class="row row-eq-height">
        ...
        <div class="col-xs-12 col-md-5">
            <div class="col-xs-12 fundo-azul borda-preta">
                <div class="quadro-amarelo borda-preta margem text-center">
                    <h3>E como funciona?</h3>

                    <div class="como-funciona">
                        <div class="row borda-preta texto-preto margem-10 vertical">
