<header class="masthead text-center swiper">
    ...
    <div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide bg-banner001">
                <div class="row">
                    <div class="col-md-6 text-left">
                        <h3 class="">Mas que história é essa?</h3>

                        <p class="lead mt-3"> O Parlamento Juvenil da ALERJ é dos primeiros projetos do Brasil que simula com os jovens o funcionamento do Legislativo.</p>
                        ...
                        <a class="btn btn-primary mt-5" href="#" role="button"><i class="fas fa-plus-circle"></i> Saiba Mais</a>
                    </div>
            ...
            <div class="swiper-slide bg-banner002">
                <div class="row">
                    <div class="col-md-6">
                        <img src="/templates/{{ get_current_year() }}/assets/img/site2016-mockup.png" class="img-fluid"><br>
                        imagem do site da edição de 2016
