    ...
    <div id="vue-schools-VUE-DISABLED">
        ...
        <div class="row control-group" transition="expand">
            <div class="form-group col-12 floating-label-form-group controls">
                ...
                <select class="form-control input-lg" placeholder="Município" name="city" id="city" required data-validation-required-message="Por favor preencha o município." v-model="city">
...
<script>
    ...
    {!! (isset($subscription) && isset($subscription->id)) ? ('window.subscriptionId = ' . $subscription->id) : ''!!}
