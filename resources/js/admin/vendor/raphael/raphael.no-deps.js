    ...
    return /******/ (function (modules) {
                    ...
                    R.is = function (o, type) {
                        ...
                        return (
                            ...
                            (type == 'array' &&
                                Array.isArray &&
                                Array.isArray(o)) ||
                            objectToString.call(o).slice(8, -1).toLowerCase() ==
                                type
                        )
                    }
                    ...
                    var toHex = function (color) {
                            if (R.vml) {
                                ...
                                toHex = cacher(function (color) {
                                    try {
                                        bod.style.color = Str(color).replace(
                                            trim,
                                            E,
                                        )
	    ...
	    \*/
                    R.findDotsAtSegment = function (
                        ...
                        var t1 = 1 - t,
                            ...
                            cy = t1 * c2y + t * p2y,
                            alpha =
                                90 - (math.atan2(mx - nx, my - ny) * 180) / PI
	            ...
	            \*/
                        ...
                        equaliseTransform = (R._equaliseTransform = function (
                            ...
                            for (; i < maxlength; i++) {
                                ...
                                to[i] = []
                                for (
                                    j = 0, jj = mmax(tt1.length, tt2.length);
                                    j < jj;
                                    j++
                                ) {
	    ...
	    \*/
                    elproto.glow = function (glow) {
                        ...
                        var s = {
                                ...
                                opacity:
                                    glow.opacity == null ? 0.5 : glow.opacity,
	    ...
	    \*/
                    elproto.transform = function (tstr) {
                        ...
                        this.clip &&
                            $(this.clip, { transform: this.matrix.invert() })
