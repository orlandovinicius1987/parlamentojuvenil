                            ...
                            return t
                                ...
                                : ((e.dirty || e.dirtyT || !e.bbox) &&
                                      ((!e.dirty && this.realPath) ||
                                          ((e.bboxwt = 0),
                                          (this.realPath = Et[this.type](
                                              this,
                                          ))),
                                      (e.bbox = Ot(
                                          Nt(this.realPath, this.matrix),
                                      )),
                                      (e.bbox.toString = v),
                                      (e.dirty = e.dirtyT = 0)),
                                  e.bbox)
                ...
                ;(d._events = p),
                    ...
                    (d.on = function (t, e) {
                        if (((t = String(t)), 'function' != typeof e))
                            return function () {}
                        for (
                            var r = t.split(o), i = p, n = 0, a = r.length;
                            a > n;
                            n++
                        )
                            (i = i.n),
                                (i =
                                    (i.hasOwnProperty(r[n]) && i[r[n]]) ||
                                    (i[r[n]] = { n: {} }))
