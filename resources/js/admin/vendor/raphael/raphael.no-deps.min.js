                ...
                (n = function (t) {
                    ...
                    function p(t, r, i) {
                        ...
                        for (
                            ...
                            var v = e.findDotsAtSegment.apply(
                                e,
                                t.concat(x / h),
                            )
                    ...
                    var w,
                        ...
                        z =
                            ...
                            (A.win.DocumentTouch &&
                                A.doc instanceof DocumentTouch),
                        R = '',
                        j = ' ',
                        q = String,
                        I = 'split',
                    ...
                    ;(e.getRGB = n(function (t) {
                        ...
                        !(
                            xt[T](t.toLowerCase().substring(0, 2)) ||
                            '#' == t.charAt()
                        ) && (t = Pt(t))
                        var r,
                            i,
                    ...
                    ;(ye.drag = function (r, i, n, a, s, o) {
                        function l(l) {
                            ...
                            var h = l.clientX,
                                ...
                                f =
                                    ...
                                    A.doc.body.scrollLeft
                            if (
                                ((this._drag.id = l.identifier), z && l.touches)
                            )
                        ...
                        (ye.undrag = function () {
                            ...
                            !be.length && e.unmousemove(xe).unmouseup(ve),
                                (ge = [])
                        }),
                            ...
                            return t
                                ...
                                : ((e.dirty || e.dirtyT || !e.bbox) &&
                                      ((!e.dirty && this.realPath) ||
                                          ((e.bboxwt = 0),
                                          (this.realPath = Nt[this.type](
                                              this,
                                          ))),
                                      (e.bbox = Ot(
                                          Et(this.realPath, this.matrix),
                                      )),
                                      (e.bbox.toString = v),
                                      (e.dirty = e.dirtyT = 0)),
                                  e.bbox)
                    ...
                    if (!t || t.svg) {
                        ...
                        ;(A.prototype = N),
                            ...
                            (N.transform = function (r) {
                                ...
                                return (
                                    (i.transform = this.matrix.toTransformString()),
                                    this
                                )
                            }),
                            (N.hide = function () {
                    ...
                    if (!t || t.vml) {
                        ...
                        var S = function (t, e, i) {
                            ...
                            A = function (e, a, s) {
                                ...
                                if (((e = e.shape || e.node), x.length)) {
                                    ...
                                    for (
                                        var v = [], y = 0, m = x.length;
                                        m > y;
                                        y++
                                    )
                                        x[y].offset &&
                                            v.push(x[y].offset + p + x[y].color)
                                    ;(s.colors = v.length
                                        ? v.join()
                                        : '0% ' + s.color),
                                        'radial' == c
                        ...
                        ;(t._engine.initWin = function (t) {
                            ...
                            (t._engine.create = function () {
                                ...
                                var l = new t._Paper(),
                                    h = (l.canvas = t._g.doc.createElement(
                                        'div',
                                    )),
                                    u = h.style
                                return (
